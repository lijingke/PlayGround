//
//  FinalEvaluationJudgeAnswerCell.swift
//  PlayGround
//
...
class FinalEvaluationJudgeAnswerCell: UITableViewCell {
    ...
    lazy var answerView: FinalEvaluationJudgeAnswerView = {
        let view = FinalEvaluationJudgeAnswerView()
...
extension FinalEvaluationJudgeAnswerCell {
